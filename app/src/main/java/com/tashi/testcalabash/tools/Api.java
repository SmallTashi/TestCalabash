...
public class Api {
    ...
    public static final String LOGIN = "https://www.huluzc.com/calabash/session";
    //Post Reset
    ...
    public static final String THEME_VIEW_PAGER = "https://www.huluzc.com/calabash/figure?category=1&client_category=web";
    public static final String RECOMMEND_VIEW_PAGER = "https://www.huluzc.com/calabash/figure?category=0&client_category=web";
    //get theme_world
    //topic_id
    public static final String THEME_WORLD = "https://www.huluzc.com/worlds/";
    //Recommend_article_api
    public static final String RECOMMEND_ALL = "https://www.huluzc.com/calabash/article/nominate?page=1&page_per=10";
    //get tell username
    //param : user_name
